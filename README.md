...
- If `no_budget_phrase` is set, a parallel LLM call (small model) checks if the message contains a fuzzy match — if so, the budget is omitted. Handles dictation typos (e.g., "de mateo" / "de matteo" / "de matteoo")
